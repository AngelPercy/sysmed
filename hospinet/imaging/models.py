...
class EstudioProgramado(models.Model):
    ...
    NORMAL = (
        ("1", u'NORMAL 0/0'),
        ("2", u'NORMAL CERO'),
        ("3", u'SIN NEUMOCONIOSIS'),
    )

    SOSPECHA = (
        ("4", u'SOSPECHA 1/O'),
        ("5", u'SOSPECHA 1/0'),
        ("6", u'IMG. RAD. EXPLOSION A POLVO'),
    )
    ...
    n_rx = models.CharField(max_length=100, blank=True, verbose_name=u'N° RX:')
    fecha = models.DateField(default=date.today)
    calidad = models.CharField(max_length=100, blank=True, verbose_name=u'CALIDAD:')
    simbolo = models.CharField(max_length=100, blank=True, verbose_name=u'SIMBOLOS:')
    campo_pulmonar = models.CharField(max_length=200, blank=True, verbose_name=u'CAMPO PULMONAR')
    hilios = models.CharField(max_length=100, blank=True, verbose_name=u'HILIOS:')
    mediastino = models.CharField(max_length=100, blank=True, verbose_name=u'MEDIASTINO:')
    senos = models.CharField(max_length=100, blank=True, verbose_name=u'SENOS:')
    silueta_cardiovascular = models.CharField(max_length=100, blank=True, verbose_name=u'SILUETA CARDIOVASCULAR')
    conclu_radiograficas = models.CharField(max_length=100, blank=True, verbose_name=u'CONCLUCIONES RADIOGRAFICAS')
    normal = models.CharField(max_length=1, choices=NORMAL, blank=True)
    sospecha = models.CharField(max_length=1, choices=SOSPECHA, blank=True)
    con_neumoconiosis = models.CharField(max_length=1, choices=NEUMOCO, blank=True)
